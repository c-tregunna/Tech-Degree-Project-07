...
$(".update-daily").on("click", function() {
    ...
    lineChart.data.datasets[0].backgroundColor = 'rgba(85, 186, 236, .8)';
    lineChart.update();
});
...
$(".update-weekly").on("click", function() {
    ...
    lineChart.data.datasets[0].backgroundColor = 'rgba(225, 239, 56, .8)';
    lineChart.update();
});
...
$(".update-monthly").on("click", function() {
    ...
    lineChart.data.datasets[0].backgroundColor = 'rgba(241, 161, 11, .8)';
    lineChart.update();
});
